...
RIR4 = audio4;
EchoCandidates4 = echolabelling(U(3,:),origSound,RIR4,Fs,K,prior3(1,1:2),[xrange(x3),yrange(y3)]);
...
RIR5 = audio5;
EchoCandidates5 = echolabelling(U(4,:),origSound,RIR5,Fs,K,prior4(1,1:2),[xrange(x4),yrange(y4)]);
...
RIR6 = audio6;
EchoCandidates6 = echolabelling(U(5,:),origSound,RIR6,Fs,K,prior5(1,1:2),[xrange(x5),yrange(y5)]);
...
RIR7 = audio7;
EchoCandidates7 = echolabelling(U(6,:),origSound,RIR7,Fs,K,prior6(1,1:2),[xrange(x6),yrange(y6)]);
